...
return (
    <Card className="bg-[#23272e] mb-6">
    <CardHeader>
        <CardTitle className="text-green-400">EEG Live</CardTitle>
    </CardHeader>
    <CardContent>
        ...
        <>
            ...
            >
                ...
                domain={[-2, 2]}
                tick={{ fill: "#aaa", fontSize: 12 }}
                label={{ value: "μV", angle: -90, fill: "#aaa", fontSize: 12, position: "insideLeft" }}
                axisLine={{ stroke: "#444" }}
                tickLine={false}
                width={40}
                />
            ...
            <div className="text-xs text-gray-400 mt-2">EEG: Electroencephalogram (μV vs Time)</div>
        </>
        </ChartContainer>
    </CardContent>
    </Card>
