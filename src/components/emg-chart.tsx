...
export function EMGChart() {
  return (
    <Card className="bg-white">
      <CardHeader>
        <CardTitle className="text-blue-700">EMG Live</CardTitle>
      </CardHeader>
      <CardContent>
        <ChartContainer className="h-[280px] w-full" config={{}}>
          <>
              ...
              <ResponsiveContainer width="100%" height={260}>
                ...
                >
                  ...
                  <YAxis
                    domain={[-2, 2]}
                    tick={{ fill: "#374151", fontSize: 12 }}
                    label={{ value: "mV", angle: -90, fill: "#374151", fontSize: 12, position: "insideLeft" }}
                    axisLine={{ stroke: "#e5e7eb" }}
                    tickLine={false}
                    width={40}
                  />
            ...
            <div className="text-xs text-gray-500 mt-2">EMG: Electromyogram (mV vs Time)</div>
          </>
        </ChartContainer>
      </CardContent>
    </Card>
